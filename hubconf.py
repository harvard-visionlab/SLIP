...
def vits16_clip_25ep_yfcc15M(pretrained=True, **kwargs):
	...
	"""
	model = _models.CLIP_VITS16(**kwargs)
	if pretrained:
...
def vits16_simclr_25ep_yfcc15M(pretrained=True, ssl_mlp_dim=4096, ssl_emb_dim=256, **kwargs):
	...
	pretrained (bool): kwargs, load pretrained weights into the model
	"""
	model = _models.SIMCLR_VITS16(ssl_mlp_dim=ssl_mlp_dim, ssl_emb_dim=ssl_emb_dim, **kwargs)
	if pretrained:
...
def vits16_slip_50ep_yfcc15M(pretrained=True, ssl_mlp_dim=4096, ssl_emb_dim=256, **kwargs):
	...
	pretrained (bool): kwargs, load pretrained weights into the model
	"""
	model = _models.SLIP_VITS16(ssl_mlp_dim=ssl_mlp_dim, ssl_emb_dim=ssl_emb_dim, **kwargs)
	if pretrained:
...
def vitb16_clip_25ep_yfcc15M(pretrained=True, **kwargs):
	...
	pretrained (bool): kwargs, load pretrained weights into the model
	"""
	model = _models.CLIP_VITB16(**kwargs)
	if pretrained:
...
def vitb16_simclr_25ep_yfcc15M(pretrained=True, ssl_mlp_dim=4096, ssl_emb_dim=256, **kwargs):
	...
	pretrained (bool): kwargs, load pretrained weights into the model
	"""
	model = _models.SIMCLR_VITB16(ssl_mlp_dim=ssl_mlp_dim, ssl_emb_dim=ssl_emb_dim, **kwargs)
	if pretrained:
...
def vitb16_slip_25ep_yfcc15M(pretrained=True, ssl_mlp_dim=4096, ssl_emb_dim=256, **kwargs):
	...
	pretrained (bool): kwargs, load pretrained weights into the model
	"""
	model = _models.SLIP_VITB16(ssl_mlp_dim=ssl_mlp_dim, ssl_emb_dim=ssl_emb_dim, **kwargs)
	if pretrained:
...
def vitl16_clip_25ep_yfcc15M(pretrained=True, **kwargs):
	...
	pretrained (bool): kwargs, load pretrained weights into the model
	"""
	model = _models.CLIP_VITL16(**kwargs)
	if pretrained:
...
def vitl16_simclr_25ep_yfcc15M(pretrained=True, ssl_mlp_dim=4096, ssl_emb_dim=256, **kwargs):
	...
	pretrained (bool): kwargs, load pretrained weights into the model
	"""
	model = _models.SIMCLR_VITL16(ssl_mlp_dim=ssl_mlp_dim, ssl_emb_dim=ssl_emb_dim, **kwargs)
	if pretrained:
...
def vitl16_slip_25ep_yfcc15M(pretrained=True, ssl_mlp_dim=4096, ssl_emb_dim=256, **kwargs):
	...
	pretrained (bool): kwargs, load pretrained weights into the model
	"""
	model = _models.SLIP_VITL16(ssl_mlp_dim=ssl_mlp_dim, ssl_emb_dim=ssl_emb_dim, **kwargs)
	if pretrained:
